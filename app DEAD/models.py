...
class Post(Base):
    ...
    def is_authenticated(self):
        return True
# This method returns true unless the object that represents user should not be allowed to authenticate

    def is_active(self):
        return True

# This method should return True for users unless they are inactive, banned, etc.

    def is_anonymous(self):
        return False

#Should return True only for fake users that aren't supposed to be logging in the system.
...
#Return a unique identifer for user in inque format using the inquie id generated by the database layer for this.
